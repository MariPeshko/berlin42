...
/*   Updated: 2024/04/05 21:48:19 by mpeshko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
(String buff is used for reading a file, its size is based on BUFFER_SIZE is set in the header file.
In a loop - reading the file and filling the static array storage using the function ft_storage_plus_buffer
Conditions of the loop: 1) there is ??????? 2) there is at least 1 byte in a file.)
...
'storage'.
Function 'ft_trim_until_newline': Afterward, the 'storage' is trimmed so it only contains content after
